...
void Vtop::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/shakti/Desktop/CAD/Project1/MAC_pipelined_coverage_int/verilog/mkTopMAC.v", 37, "",
...
VL_INLINE_OPT void Vtop::_sequent__TOP__4(Vtop__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->RST_N) {
        if (vlTOPp->mkTopMAC__DOT__inp_fifo_rv_EN) {
            vlTOPp->mkTopMAC__DOT__inp_fifo_rv[0U] 
                = vlTOPp->mkTopMAC__DOT__inp_fifo_rv_D_IN[0U];
            vlTOPp->mkTopMAC__DOT__inp_fifo_rv[1U] 
                = vlTOPp->mkTopMAC__DOT__inp_fifo_rv_D_IN[1U];
            vlTOPp->mkTopMAC__DOT__inp_fifo_rv[2U] 
                = vlTOPp->mkTopMAC__DOT__inp_fifo_rv_D_IN[2U];
        }
    } else {
        vlTOPp->mkTopMAC__DOT__inp_fifo_rv[0U] = 0U;
        vlTOPp->mkTopMAC__DOT__inp_fifo_rv[1U] = 0U;
        vlTOPp->mkTopMAC__DOT__inp_fifo_rv[2U] = 0U;
    }
    if (vlTOPp->RST_N) {
        if (vlTOPp->mkTopMAC__DOT__stage1_fifo_rv_EN) {
        ...
        vlTOPp->mkTopMAC__DOT__stage1_fifo_rv[0U] = 0U;
        vlTOPp->mkTopMAC__DOT__stage1_fifo_rv[1U] = 0U;
