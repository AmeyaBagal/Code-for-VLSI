...
mac_coverage = coverage_section(
    ...
    CoverPoint('top.get_inputs_a', vname='get_inputs_a', bins = list(range(-16,16)) + [-128,127]),
    CoverPoint('top.get_inputs_b', vname='get_inputs_b', bins = list(range(-16,16)) + [-128,127]),
    CoverPoint('top.get_inputs_c', vname='get_inputs_c', bins = list(range(-16,16)) + [-2147483648,-2147467392, 2147467518, 2147483647]),
